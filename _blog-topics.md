# Blog Topic Backlog (SEO content engine)

The scheduled routine picks the FIRST unchecked `- [ ]` topic each run, writes the post, then checks it off `- [x]`. Topics are ordered by SEO priority (high-intent + low-competition first). Add new topics anytime.
...
- [ ] The Small Business Health Care Tax Credit: Do You Qualify?

## Seasonal / local
- [ ] New to Virginia (or Moving)? Your Health Coverage Checklist
- [ ] Medicare in Northern Virginia: A Local Guide
